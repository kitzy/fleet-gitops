...
This project uses [Contour](https://github.com/macadmins/contour) for macOS MDM configuration management.
...
Organization config is in `.contour/config.toml`. Tool-specific policy files (pppc.toml, santa.toml, etc.) live in the project root or subdirectories.
...
<!-- Generated by contour 0.4.0-beta.4 — regenerate with: contour help-ai --install-skill -->
